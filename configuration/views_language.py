    ...
    for dict in list_data_dict:
        ...
        if lang_detail_query.exclude(value='').count()>0:# complete translation exists
            ...
            try:
                ...
                translated=''
                m=e
            lang_detail_obj=Language_Detail(id_field=id_field,dest=language_obj,src=src,value=translated,text=text)
        ...
        try:
            ...
            m=e
            pass
    data=Language_Detail.objects.filter(dest=language_obj).values_list("id_field","value","text")    
    return Response(data=data)