...
console.log('response ',response)
    ...
    const selectedLocation = update_location_at_bill ? update_location_at_bill.value : location.value;
    ...
    if(selectedLocation!='')
    {
        ...
        if(parseInt(selectedLocation)===parseInt(response.data[i].id))
        {
        console.log('selected location matches data id ',selectedLocation==response.data[i].id);
